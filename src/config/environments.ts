...
const ENV_CONFIGS: Record<AppEnvironment, FirebaseConfig> = {
  production: {
    ...
    appId: process.env.EXPO_PUBLIC_FIREBASE_PROD_APP_ID || (Platform.OS === 'ios' ? "1:130463348213:ios:37cd8d90e50d18735d5cbc" : Platform.OS === 'android' ? "1:130463348213:android:915ef85a74cbd6fc5d5cbc" : "1:130463348213:web:56e7fc5bfd0759115d5cbc"),
  ...
  staging: {
    ...
    appId: process.env.EXPO_PUBLIC_FIREBASE_STAGING_APP_ID || process.env.EXPO_PUBLIC_FIREBASE_APP_ID || (Platform.OS === 'ios' ? "1:130463348213:ios:37cd8d90e50d18735d5cbc" : Platform.OS === 'android' ? "1:130463348213:android:915ef85a74cbd6fc5d5cbc" : "1:130463348213:web:56e7fc5bfd0759115d5cbc"),
...
export const getInitialSelectedEnvironmentSync = (): AppEnvironment => {
  ...
  return BUILD_ENV; // Default to the build's own environment (staging stays on staging)
};
...
export const getSavedEnvironment = async (): Promise<AppEnvironment> => {
  ...
  return BUILD_ENV; // Default to the build's own environment
};
