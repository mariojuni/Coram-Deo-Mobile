...
const ENV_CONFIGS: Record<AppEnvironment, FirebaseConfig> = {
  ...
  staging: {
    apiKey: process.env.EXPO_PUBLIC_FIREBASE_STAGING_API_KEY || process.env.EXPO_PUBLIC_FIREBASE_API_KEY || "AIzaSyATJtgk582X0ik4GwqXes64uE6OMxsXrfw",
    authDomain: process.env.EXPO_PUBLIC_FIREBASE_STAGING_AUTH_DOMAIN || process.env.EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN || "nazarenechurch-9c030.firebaseapp.com",
    projectId: process.env.EXPO_PUBLIC_FIREBASE_STAGING_PROJECT_ID || process.env.EXPO_PUBLIC_FIREBASE_PROJECT_ID || "nazarenechurch-9c030",
    storageBucket: process.env.EXPO_PUBLIC_FIREBASE_STAGING_STORAGE_BUCKET || process.env.EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET || "nazarenechurch-9c030.firebasestorage.app",
    messagingSenderId: process.env.EXPO_PUBLIC_FIREBASE_STAGING_MESSAGING_SENDER_ID || process.env.EXPO_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || "676505939287",
    appId: process.env.EXPO_PUBLIC_FIREBASE_STAGING_APP_ID || process.env.EXPO_PUBLIC_FIREBASE_APP_ID || "1:676505939287:web:f7c7b5df9ff77e2eeda212",
    measurementId: process.env.EXPO_PUBLIC_FIREBASE_STAGING_MEASUREMENT_ID || process.env.EXPO_PUBLIC_FIREBASE_MEASUREMENT_ID || "G-KRZ6NG9FT8",
    googleWebClientId: process.env.EXPO_PUBLIC_GOOGLE_WEB_CLIENT_ID_STAGING || "676505939287-eqsoa6bc8tkgkun3bmqtdmu2418hnu7m.apps.googleusercontent.com",
    googleIosClientId: process.env.EXPO_PUBLIC_GOOGLE_IOS_CLIENT_ID_STAGING || "676505939287-dudp40gr0pns1kpff4fc1ohu6qt4ha92.apps.googleusercontent.com",
  },
};
